...
public class GOOD6 extends AppCompatActivity {
    ...
    public void toSHOP(View v) {
        ...
        startActivity(new Intent(GOOD6.this,SHOP.class));finish();
    }
    public void buy(View v){
        sound.play(BTN, 1, 1, 0, 0, 1);//按鈕音效
        Test_Data test=new Test_Data(com.example.coyi.walter.GOOD6.this);
        ...
        if (money >= 1500){
            ...
            money = money - 1500;
            //購買成功
            Toast toast = Toast.makeText(com.example.coyi.walter.GOOD6.this, "購買成功!", Toast.LENGTH_LONG);
            toast.show();
        }
        else {Toast toast = Toast.makeText(com.example.coyi.walter.GOOD6.this, "餘額不足!", Toast.LENGTH_LONG);
            toast.show();}
        for(Item i:items) {
            i.setGood6(good6);
            i.setMoney(money);
